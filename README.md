...
This will be the public repo where things that have been made are simply templates.

The repo has been set up to follow CI/CD practices.

Deployment workflow is as follows:\
Push feature branch -> PR to main -> Plan on Dev Account -> Merge on Main -> Deploy Main to Dev Account -> tag Main -> Plan tag on Prod Account -> Manual Approval -> Deploy tag to Prod Account